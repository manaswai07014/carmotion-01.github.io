...
**Toyota’s New MR2 May Have Just Been Caught Testing For The First Time** — that's the headline making waves in the automotive world right now, originally reported by *Autoblog*.The piece covers a development centered on Toyota that's part of a broader shift we've been tracking across the industry. Without copying the original coverage, here's the gist of what readers need to know.
